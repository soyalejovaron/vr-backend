...
parser.on('data', function (data){
    // Creamos las variables que necesitaremos para almacenar ciertos datos, que a su vez, seran guardadas en una consulta SQL
    let idL = 1;
    ...
    /* Creamos una consulta SQL en caso de que se requiera en algun momento guardar el historico de la lluvia */
   /*  const sql = `INSERT INTO sensorL SET ?`;
    const sensorObject = {
    ...
    /* aquí crearemos nuestra consulta SQL, donde haremos un update de los datos que se encuentran en la base de datos
    y la tabla de lluvia, para guardar dichos datos
    */
